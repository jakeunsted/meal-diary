describe('Shopping list', () => {
  ...
  it('adds, checks and removes an item', () => {
    ...
    cy.contains('[data-testid^="shopping-item-name-"]', 'Milk')
    ...
    cy.contains('[data-testid^="shopping-item-name-"]', 'Milk').should('not.exist');

    cy.contains('[data-testid^="shopping-item-name-"]', 'Tomatoes')
      .closest('div.flex.items-center.justify-between.list-none.px-2.py-1')
