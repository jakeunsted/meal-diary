...
/** ISO week Monday for the given reference date (local calendar). */
export function getCurrentWeekStartDate(referenceDate: Date = new Date()): string {
  return normalizeMealDiaryWeekKey(referenceDate);
}
