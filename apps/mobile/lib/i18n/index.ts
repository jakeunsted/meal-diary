...
const resources = {
  en: {
    translation: {
      ...
      shoppingList: {
        title: 'Shopping List',
        loadFailed: 'Failed to load shopping list',
        retry: 'Retry',
      ...
      recipeDetail: {
        ...
        deleteConfirm:
          'Are you sure you want to delete this recipe? It will also be removed from any meal diary entries.',
      ...
      plansPage: {
        title: 'Family Plus plans',
        intro:
          'Compare free and paid features for your household. Family Plus unlocks more members, planning ahead, unlimited recipes, and more.',
        free: 'Free',
        familyPlus: 'Family Plus',
        complimentary: 'Complimentary Family Plus',
        compareTitle: "What's included",
        subscription: 'Subscription',
        monthly: 'Monthly',
        yearly: 'Yearly',
        trialBadge: '7-day free trial',
        freeDescription: 'Core meal diary and shopping list for couples.',
        currentPlanBadge: 'Always free',
        startFreeTrial: 'Start 7-day free trial',
        subscribeNow: 'Subscribe now',
        askOwnerToUpgrade: 'Ask {{name}} to upgrade',
        askOwnerToUpgradeGeneric: 'Ask family owner to upgrade',
        ownerManagesBilling: '{{name}} manages billing for this family',
        manageBilling: 'Manage billing',
        manageSubscription: 'Manage subscription',
        manageOnWeb: 'Manage on web',
        managedOnWeb:
          'This family already has Family Plus via the website. Manage billing there.',
        complimentaryPlanMessage: 'You have a complimentary Family Plus plan.',
        currentPlanLabel: 'Your plan: {{plan}}',
        trialDaysRemaining: '{{days}} days left in your free trial',
        paymentFailed: 'Payment failed. Update your subscription to keep Family Plus.',
        viewPlans: 'View plans',
        viewWebPlans: 'View plans on the web',
        ...
        rows: {
          ...
          editPastWeeks: 'Edit past weeks',
          recipes: 'Unlimited recipes',
          recipeToShoppingList: 'Add recipe ingredients to shopping list',
        },
      },
      common: {
        close: 'Close',
